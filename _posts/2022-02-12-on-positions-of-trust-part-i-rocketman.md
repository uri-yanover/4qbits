...
By the late 1950s, the ABMA team was able to produce a new ballistic missile design, commissioned into military use as Jupiter. Jupiter was then up-engineered into the Juno which wasn't a ballistic missile anymore - it was a space-grade launcher. The ABMA team was then merged into NASA, and in 1960 von Braun was appointed as the founding Director of the Marshall Space Flight Center. He accepted that role on the condition he would be able to develop the Saturn launcher. This was accepted; Saturn was developed and was the launch vehicle that brought mankind to the moon in July 1969; von Braun retired from government service a year after that.
